...
RegisterNetEvent('LOST-crafting:server:craftItem', function(item, location, amount) 
...
QBCore.Functions.CreateCallback('LOST-crafting:server:enoughMaterials', function(source, cb, materials, amountToCraft)
    local src = source
